...
export function CookieBanner() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-gray-900 px-4 py-3">
            <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
                ...
                <button
                    ...
                    className="shrink-0 rounded bg-amber-500 px-6 py-2 text-sm font-medium text-gray-900 transition-colors hover:bg-amber-400"
                >
                    Принимаю
                </button>
            </div>
